    ...
    <div class="builder-sidebar" id="builder-sidebar">
      ...
      <span></span>
        ...
        <ul class="navbar-nav nav-dropdown mbr-column nav-right" data-app-modern-menu="true"><li class="nav-item">
            <a class="nav-link link text-black display-4" href="home.php" aria-expanded="true">Home</a>
...
<section class="footer2 cid-sizk6BLSn0" id="footer2-d">
        ...
        <div class="mbr-row mbr-jc-c">
            ...
            <div class="items-col mbr-col-sm-12 align-right mbr-col-md-4">
                ...
                <p class="item mbr-semibold mbr-fonts-style mbr-py-1 display-4">
                        Muhammad Rizky Gaez</p><p class="item mbr-semibold mbr-fonts-style mbr-py-1 display-4">
